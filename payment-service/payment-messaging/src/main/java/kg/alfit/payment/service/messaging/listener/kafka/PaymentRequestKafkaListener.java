package kg.alfit.payment.service.messaging.listener.kafka;

import kg.alfit.kafka.consumer.KafkaConsumer;
import kg.alfit.kafka.order.avro.model.PaymentOrderStatus;
import kg.alfit.kafka.order.avro.model.PaymentRequestAvroModel;
import kg.alfit.payment.service.domain.ports.input.message.listener.service.PaymentRequestMessageListener;
...
public class PaymentRequestKafkaListener implements KafkaConsumer<PaymentRequestAvroModel> {
    ...
    public void receive(@Payload List<PaymentRequestAvroModel> messages,
        ...
        log.info("{} number of payment requests received with keys:{}, " +
